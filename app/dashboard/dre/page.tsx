            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-muted/50 border-b border-border">
                  <th className="text-left p-3 font-semibold min-w-36 sticky left-0 bg-muted/50">Categoria</th>
                  {MONTHS.map(m => (
              ...
              <tbody>
                ...
                {activeIncome.map(cat => (
                  <tr key={cat} className="border-t border-border hover:bg-muted/30 transition-colors">
                    <td className="p-2 px-3 sticky left-0 bg-background">{cat}</td>
                    {MONTHS.map(m => {
                ...
                <tr className="border-t-2 border-green-300 dark:border-green-800 bg-green-50/70 dark:bg-green-950/20">
                  <td className="p-2.5 px-3 font-bold text-green-700 dark:text-green-400 sticky left-0 bg-green-50 dark:bg-green-950/20">Total Receitas</td>
                  {MONTHS.map(m => {
                ...
                <tr className="border-t-2 border-red-300 dark:border-red-800 bg-red-50/70 dark:bg-red-950/20">
                  <td className="p-2.5 px-3 font-bold text-red-700 dark:text-red-400 sticky left-0 bg-red-50 dark:bg-red-950/20">Total Despesas</td>
                  {MONTHS.map(m => {
                ...
                <tr className="border-t-4 border-border bg-muted/50">
                  <td className="p-3 px-3 font-bold text-sm sticky left-0 bg-muted/50">Resultado</td>
                  {MONTHS.map(m => {
