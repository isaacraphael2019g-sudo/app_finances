...
import { Wallet, TrendingUp, ShieldCheck, BarChart3 } from 'lucide-react'
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0c111d] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative space-y-8">
          <div>
            <h1 className="text-4xl font-extrabold text-white leading-tight">
              Controle total<br />
              das suas <span className="text-emerald-400">finanças</span>
            </h1>
            <p className="text-slate-400 mt-4 text-lg leading-relaxed">
              Acompanhe receitas, despesas e investimentos com inteligência artificial integrada.
            </p>
          </div>

          <div className="space-y-4">
            {[
              { icon: TrendingUp, text: 'Dashboard com gráficos em tempo real' },
              { icon: ShieldCheck, text: 'Dados protegidos com criptografia ponta a ponta' },
              { icon: BarChart3, text: 'Análises inteligentes com IA integrada' },
            ].map(({ icon: Icon, text }) => (
        ...
        <p className="relative text-slate-600 text-xs">
          &ldquo;A saúde financeira começa com consciência.&rdquo;
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-sm space-y-8">
          ...
          <p className="text-center text-sm text-muted-foreground">
            Não tem conta?{' '}
            <Link href="/signup" className="text-emerald-600 hover:text-emerald-500 font-semibold transition-colors">
              Criar conta grátis
            </Link>
          </p>
        </div>
